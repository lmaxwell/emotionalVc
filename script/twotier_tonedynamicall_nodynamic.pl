...
#===============================================================================
#
#         FILE: twotier_tonedynamicall_nodynamic.pl
#
#        USAGE: ./twotier_tonedynamicall_nodynamic.pl  ../config/config.pm  emotion mixNumOfPhrase mixNumOfTone mode
#
#  DESCRIPTION: 
#
#      OPTIONS: ---
...
if($doTest)
{
	...
	for my $testToneFile(@testToneFiles)
	{
		...
		print M "x=[@alltone]';\n";
		print M "predict=gmm_convert(x,32,$mixNum{$emotion}[1],\'$trainDir/neutral_$emotion.tone.gmm\',\'trajectory_d_nodynamic\');\n";
		for my $t(0..$T-1)
		{
