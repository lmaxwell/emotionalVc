...
#===============================================================================
#
#         FILE: twotier_nodynamic.pl
#
#        USAGE: ./twotier_nodynamic_ar_full.pl  ../config/config.pm  emotion mixNumOfPhrase mixNumOfTone mode
#
#  DESCRIPTION: 
#
#      OPTIONS: ---
...
if ($doTrain)
{
	...
	system("$SPTK/gmm -b 100 -l 16 -m $mixNum{$emotion}[1] -f $trainDir/neutral_$emotion.tone.f >$trainDir/neutral_$emotion.tone.gmm.f");
